    ...
    public boolean isChainValid() {
        for (int i = 1; i < chain.size(); i++) {
            ...
            if (!currBlock.hash.equals(currBlock.calculateHash()) ||
                    !currBlock.prevHash.equals(prevBlock.hash)) {
                return false;
            }
        }
        return true;
...
public class Main {
    public static void main(String[] args) {
        ...
        bcNode node2 = new bcNode(82, blockchain.chain);
        printColore("ANSI_RED", "After original Blockchain");
    ...
    private static void printColore(String Color, String Text){
